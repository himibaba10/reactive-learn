...
export const LessonAccessForm = ({ initialData, lessonId }) => {
  ...
  const [currentAccess, setCurrentAccess] = useState(initialData?.access);
  ...
  const onSubmit = async (values) => {
    try {
      const accessValue = values.access ? 'public' : 'private';

      await updateLesson(lessonId, { access: accessValue });
